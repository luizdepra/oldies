...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Dungeon", "com.example.myapp", "0.0.1");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Dungeon", null, { width: 768, height: 432 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 768, height: 432 });
			#end
