...
@:keep class __ASSET__assets_images_auto_tiles_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:bitmap("assets/images/auto_tiles.png") class __ASSET__assets_images_auto_tiles_png extends flash.display.BitmapData {}
...
@:sound("E:/Development/HaxeToolkit/haxe/lime/flixel/3,3,5/assets/sounds/beep.mp3") class __ASSET__assets_sounds_beep_mp3 extends flash.media.Sound {}
@:sound("E:/Development/HaxeToolkit/haxe/lime/flixel/3,3,5/assets/sounds/flixel.mp3") class __ASSET__assets_sounds_flixel_mp3 extends flash.media.Sound {}
